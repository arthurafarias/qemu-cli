...
from qemu_cli.core.vm_manager import VmManager
...
def test_path_for_user_dir_takes_priority_over_system_dir(isolated_dirs):
    ...
    assert VmManager().path_for("myvm") == user_path
